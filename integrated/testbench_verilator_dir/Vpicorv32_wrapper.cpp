...
void Vpicorv32_wrapper::_eval(Vpicorv32_wrapper__Syms* __restrict vlSymsp) {
    ...
    if (((IData)(vlTOPp->clk) & (~ (IData)(vlTOPp->__Vclklast__TOP__clk)))) {
        ...
        vlSymsp->TOP__picorv32_wrapper__mem._sequent__TOP__picorv32_wrapper__mem__1(vlSymsp);
    }
    if (((IData)(vlTOPp->clk) ^ (IData)(vlTOPp->__Vclklast__TOP__clk))) {
    ...
    if (((IData)(vlTOPp->clk) ^ (IData)(vlTOPp->__Vclklast__TOP__clk))) {
        vlSymsp->TOP__picorv32_wrapper__mem._sequent__TOP__picorv32_wrapper__mem__8(vlSymsp);
...
void Vpicorv32_wrapper::_eval_settle(Vpicorv32_wrapper__Syms* __restrict vlSymsp) {
    ...
    Vpicorv32_wrapper* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlSymsp->TOP__picorv32_wrapper__mem._settle__TOP__picorv32_wrapper__mem__5(vlSymsp);
    vlTOPp->__Vm_traceActivity = (1U | vlTOPp->__Vm_traceActivity);
